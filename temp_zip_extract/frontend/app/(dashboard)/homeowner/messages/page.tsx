...
export default function HomeownerMessages() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      const name = params.get('name') || "Professional"
  ...
  return (
    <div className="space-y-6 animate-fade-in flex flex-col h-[80vh]">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Chat with professionals about your projects.</p>
      </div>
      ...
      <div className="flex-1 bg-card rounded-xl border border-border flex overflow-hidden">
        ...
        <div className="w-1/3 border-r border-border overflow-y-auto bg-muted/20">
          ...
          <div className="p-2 space-y-1">
            {contacts.length === 0 ? (
              <div className="p-4 text-sm text-muted-foreground text-center">No active conversations.</div>
            ) : (
